...
Contributing to sandlerprops
==============================

Thank you for your interest in contributing to sandlerprops! This document provides guidelines for contributing to the project.

Getting Started
---------------

1. **Fork the repository** on GitHub: https://github.com/cameronabrams/sandlerprops

2. **Clone your fork locally:**

   .. code-block:: bash

      git clone https://github.com/YOUR-USERNAME/sandlerprops.git
      cd sandlerprops
...
1. Check if it's already reported in `GitHub Issues <https://github.com/cameronabrams/sandlerprops/issues>`_
2. If not, create a new issue with:
   ...
   * sandlerprops version (``sandlerprops --version``)
...
Example bug report template::
   ...
   **Environment**
   ...
   - sandlerprops version: [e.g., 0.5.0]
...
sandlerprops follows PEP 8 style guidelines:
...
.. code-block:: rst
   ...
   .. autofunction:: sandlerprops.new_function
...
2. **Run tests and linting:**
   ...
   .. code-block:: bash
      ...
      pytest
      black sandlerprops tests  # Format code
      mypy sandlerprops  # Type checking (if configured)
...
Thank you for contributing to sandlerprops! Your efforts help make this tool better for everyone in the chemical engineering education community.
