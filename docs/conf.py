...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/cameronabrams/sandlerprops",
            "html": """
    ...
    # ===== Source Links =====
    "source_repository": "https://github.com/cameronabrams/sandlerprops",
    "source_branch": "main",
...
latex_documents = [
    (master_doc, 'sandlerprops.tex', 'sandlerprops Documentation',
     author, 'manual'),
]
